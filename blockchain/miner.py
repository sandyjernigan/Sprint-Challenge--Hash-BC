...
def valid_proof(last_hash, proof):
    ...
    # last five char of last_hash match
    check_last_hash = str(last_hash)[-5:]

    # first 5 char of guess_hash
    check_guess = guess_hash[:5]

    # Check if valid proof
    return check_last_hash == check_guess
